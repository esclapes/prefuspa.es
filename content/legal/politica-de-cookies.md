...
Por favor lea la política de privacidad de estas redes sociales (que puede cambiar frecuentemente) para saber que hacen con sus datos (personales) que procesan usando estas cookies. Los datos que reciben son anonimizados lo máximo posible. Facebook, WhatsApp y Instagram están ubicados en los Estados Unidos.

## 6. Cookies usadas

### Google Fonts (Marketing)
- **Google Fonts API** - Caducidad: nada - Función: Solicitar la dirección IP del usuario

### Google Maps (Marketing)
- **Google Maps API** - Caducidad: nada - Función: Solicitar la dirección IP del usuario

### Facebook (Marketing, Funcional)
Marketing:
- **_fbc** - Caducidad: 2 años - Función: Almacenar la última visita
- **fbm*** - Caducidad: 1 año - Función: Guardar detalles de la cuenta
- **xs** - Caducidad: 3 meses - Función: Almacena una ID de sesión única
- **fr** - Caducidad: 3 meses - Función: Habilitar la publicación de anuncios o retargeting
- **act** - Caducidad: 90 días - Función: Mantener los usuarios logeados
- **_fbp** - Caducidad: 3 meses - Función: Almacenar y realizar un seguimiento de las visitas a través de múltiples sitios web
- **datr** - Caducidad: 2 años - Función: Proporcionar prevención de fraude
- **c_user** - Caducidad: 30 días - Función: Almacenar un ID de usuario único
- **sb** - Caducidad: 2 años - Función: Guardar detalles del navegador
- ***_fbm_** - Caducidad: 1 año - Función: Guardar detalles de la cuenta

Funcional:
- **wd** - Caducidad: 1 semana - Función: Determinar la resolución de pantalla
- **csm** - Caducidad: 90 días - Función: Proporcionar prevención de fraude
- **actppresence** - Caducidad: sesión - Función: Almacenar y rastrear si la pestaña del navegador está activa

### WhatsApp (Funcional)
- **wa_lang_pref** - Caducidad: 6 días - Función: Guardar configuraciones de lenguaje
- **wa_ul** - Caducidad: sesión - Función: Provide access
...
- PREFUSPA VIVA S.L
- Príncipe, 25, 03791, Alicante
- España
- Web: https://www.prefuspa.es
- Correo electrónico: prefuspa@gmail.com
- Número de teléfono: +34 653 772 074

Esta política de cookies se ha sincronizado con cookiedatabase.org el 22 de noviembre de 2023.
